      ...
      <div className="Main-Area">
        <div className="Main-About">
          <div className="Opener">
            <div className="Opener-Blurb-Column">
              <div className="Main-About-Header">ABOUT</div>
              <div className="Opener-Blurb">
          ...
          <div className="Main-Blurb">
            <div className="Main-About-Bold">
              <b>Serving Illinois, Indiana, and Michigan.</b>
            </div>
            <div className="Main-About-Italics">
